                ...
                for reg_lambda_now in reg_lambda:
                    for n_estimators_now in n_estimators:
                        clf_now=XGBClassifier(objective='binary:logistic',use_label_encoder=False,learning_rate=1e-3,Feval=Feval_xg,tree_method='gpu_hist'
                                              ,gamma=0.0,min_child_weight=2,n_estimators=1000,reg_lambda=reg_lambda_now,max_depth=max_depth_now,colsample_bytree=colsample_bytree_now)#,scale_pos_weight=scale_weight
...
if __name__ == "__main__":
    ...
    args.hidden_size_ffn=args.hidden_size+6

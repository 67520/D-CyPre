...
def xg(v,t,v_val,t_val,v_test,t_test,xgmodel,val):
    ...
    if xgmodel==False:
        clf=XGBClassifier(objective='binary:logistic',use_label_encoder=False,learning_rate=1e-3,Feval=Feval_xg,tree_method='gpu_hist'
                          ,gamma=0.0,min_child_weight=2,n_estimators=1000,reg_lambda=50,max_depth=8,colsample_bytree=0.75,scale_pos_weight=0.4304629152716971)#,scale_pos_weight=scale_weight
